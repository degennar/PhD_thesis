...
\begin{table}
    \centering
    \begin{tabularx}{\linewidth}{*{8}{>{\centering\arraybackslash}X}}% <-- changed
        \hline
        \hline
...
\begin{table}
    \centering
    \begin{tabularx}{\linewidth}{*{3}{>{\centering\arraybackslash}X}}% <-- changed
        \hline
        \hline
             & occupied & empty \\
        \hline
...
\begin{table}
    \centering
    \begin{tabularx}{\linewidth}{*{1}{>{\arraybackslash}>{\hsize=2.0\hsize}X}*{6}{>{\centering\arraybackslash}X}}% <-- changed
        \hline
        \hline
